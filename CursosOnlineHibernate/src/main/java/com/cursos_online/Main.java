...
public class Main {
	...
	static final StandardServiceRegistry registry = new StandardServiceRegistryBuilder()
		...
		public static void  main(String[] args) {
			...
			//INGRESAR ESTUDIANTE
			Estudiante est1 = new Estudiante("Katheryn", "Vera");
			Estudiante est2 = new Estudiante("Nery", "Baque");
			Estudiante est3 = new Estudiante("Steven","Alvarez");	
			...
			List<Estudiante> estudiantes = getEstudiantesPorNombre("Steven");
